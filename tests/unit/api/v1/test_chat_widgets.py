...
ENDPOINT_CHAT_WIDGET_PRINCIPALS = (
    "/api/v1/platform-service/tenants/{tenant_id}/chat-widgets/{chat_widget_id}/principals"
)
ENDPOINT_PRINCIPAL_DETAIL = (
    "/api/v1/platform-service/tenants/{tenant_id}/chat-widgets/{chat_widget_id}/principals/{principal_id}"
)
...
class TestChatWidgetRoutes:
    ...
    def test_create_chat_widget_success(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.post(ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), json=cw_data, headers=headers)
    ...
    def test_create_chat_widget_with_form_type(self, test_client: TestClient, test_user_token: Any) -> None:
    ...
    def test_create_chat_widget_without_type(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test chat widget creation without type (optional)."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)

        cw_data = {"name": "Widget Without Type", "config": {"key": "value"}}
    ...
    def test_create_chat_widget_missing_config(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.post(
            ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), json={"name": "Test Widget"}, headers=headers
        )
    ...
    def test_create_chat_widget_invalid_name_type(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.post(
            ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), json={"name": 123, "config": {}}, headers=headers
        )
    ...
    def test_create_chat_widget_empty_name(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.post(
            ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), json={"name": "", "config": {}}, headers=headers
        )
    ...
    def test_create_chat_widget_empty_body(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.post(ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), json={}, headers=headers)
    ...
    def test_get_chat_widget_success(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        create_response = test_client.post(
            ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), json=cw_data, headers=headers
        )
        cw_id = create_response.json()["id"]

        # Retrieve the chat widget
        response = test_client.get(
            ENDPOINT_CHAT_WIDGET_DETAIL.format(tenant_id=tenant_id, chat_widget_id=cw_id), headers=headers
        )
    ...
    def test_get_chat_widget_not_found(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(
            ENDPOINT_CHAT_WIDGET_DETAIL.format(tenant_id=tenant_id, chat_widget_id=NON_EXISTENT_ID), headers=headers
        )
    ...
    def test_list_chat_widgets_empty(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), headers=headers)
    ...
    def test_list_chat_widgets_with_data(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        test_client.post(ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), json=cw1_data, headers=headers)
        test_client.post(ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), json=cw2_data, headers=headers)
    ...
    def test_list_chat_widgets_with_pagination(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        # Test with limit
        response = test_client.get(f"{ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id)}?limit=3", headers=headers)
        ...
        # Test with skip
        response = test_client.get(
            f"{ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id)}?skip=2&limit=2", headers=headers
        )
    ...
    def test_list_chat_widgets_with_name_filter(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        # Filter by name
        response = test_client.get(
            f"{ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id)}?name=Production", headers=headers
        )
    ...
    def test_list_chat_widgets_with_quick_list_view(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(
            f"{ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id)}?view=quick-list", headers=headers
        )
    ...
    def test_update_chat_widget_partial(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        create_tenant_for_user(test_client, test_user_token)
    ...
    def test_delete_chat_widget_success(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        delete_response = test_client.request(
            "DELETE", ENDPOINT_CHAT_WIDGET_DETAIL.format(tenant_id=tenant_id, chat_widget_id=cw_id), headers=headers
        )
...
class TestChatWidgetPrincipalRoutes:
    ...
    def test_list_chat_widget_principals_creator_only(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        # List principals
        response = test_client.get(
            ENDPOINT_CHAT_WIDGET_PRINCIPALS.format(tenant_id=tenant_id, chat_widget_id=cw_id), headers=headers
        )
        ...
        assert data["resource_type"] == "chat_widget"
    ...
    def test_get_principal_permissions(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(
            ENDPOINT_PRINCIPAL_DETAIL.format(
                tenant_id=tenant_id, chat_widget_id=cw_id, principal_id=test_user_token.get_id()
            ),
            headers=headers,
        )
    ...
    def test_delete_principal_permission(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        get_response = test_client.get(
            ENDPOINT_PRINCIPAL_DETAIL.format(tenant_id=tenant_id, chat_widget_id=cw_id, principal_id="other-user"),
            headers=headers,
        )
