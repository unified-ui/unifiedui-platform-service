...
class TestTagRBAC:
    ...
    def test_any_tenant_member_can_list_tags(self, test_client: TestClient) -> None:
        ...
        response = test_client.get(ENDPOINT_TAGS.format(tenant_id=tenant_id), headers=user_headers)
    ...
    def test_any_tenant_member_can_create_tags(self, test_client: TestClient) -> None:
        ...
        response = test_client.post(
            ENDPOINT_TAGS.format(tenant_id=tenant_id), json={"name": "USER-CREATED-TAG"}, headers=user_headers
        )
        assert response.status_code == status.HTTP_201_CREATED
    ...
    def test_non_tenant_member_cannot_list_tags(self, test_client: TestClient) -> None:
        ...
        response = test_client.get(ENDPOINT_TAGS.format(tenant_id=tenant_id), headers=outsider_headers)
    ...
    def test_non_tenant_member_cannot_create_tags(self, test_client: TestClient) -> None:
        ...
        response = test_client.post(
            ENDPOINT_TAGS.format(tenant_id=tenant_id), json={"name": "hacker-tag"}, headers=outsider_headers
        )
        assert response.status_code == status.HTTP_403_FORBIDDEN
    ...
    def test_creator_can_delete_own_tag(self, test_client: TestClient) -> None:
        ...
        response = test_client.delete(
            ENDPOINT_TAG_DETAIL.format(tenant_id=tenant_id, tag_id=tag_id), headers=user_headers
        )
        assert response.status_code == status.HTTP_204_NO_CONTENT
    ...
    def test_non_creator_non_admin_cannot_delete_tag(self, test_client: TestClient) -> None:
        ...
        response = test_client.delete(
            ENDPOINT_TAG_DETAIL.format(tenant_id=tenant_id, tag_id=tag_id), headers=user_b_headers
        )
        assert response.status_code == status.HTTP_403_FORBIDDEN
...
class TestResourceTagRBAC:
    ...
    def test_read_user_can_get_resource_tags(self, test_client: TestClient) -> None:
        ...
        admin_headers = create_auth_headers(admin_token, use_cache=False)
        tenant_id = create_tenant_for_user(test_client, admin_token)
        app_id = create_chat_agent_in_db(test_client, tenant_id, "res-tag-admin-1", "Test App")
        ...
        add_user_to_chat_agent_in_db(
            test_client, tenant_id, app_id, "res-tag-reader-1", "res-tag-admin-1", PermissionActionEnum.READ
        )

        # Reader can get tags
        response = test_client.get(
            ENDPOINT_CHAT_AGENT_TAGS.format(tenant_id=tenant_id, chat_agent_id=app_id), headers=reader_headers
        )
        assert response.status_code == status.HTTP_200_OK
    ...
    def test_read_user_cannot_set_resource_tags(self, test_client: TestClient) -> None:
        ...
        admin_headers = create_auth_headers(admin_token, use_cache=False)
        tenant_id = create_tenant_for_user(test_client, admin_token)
        app_id = create_chat_agent_in_db(test_client, tenant_id, "res-tag-admin-2", "Test App 2")
        ...
        add_user_to_chat_agent_in_db(
            test_client, tenant_id, app_id, "res-tag-reader-2", "res-tag-admin-2", PermissionActionEnum.READ
        )
    ...
    def test_read_user_cannot_delete_resource_tags(self, test_client: TestClient) -> None:
        ...
        # Admin creates tenant and chat agent with tags
        admin_token = test_client.create_test_user("res-tag-admin-3", "Resource Tag Admin 3")
        admin_headers = create_auth_headers(admin_token, use_cache=False)
        tenant_id = create_tenant_for_user(test_client, admin_token)
        app_id = create_chat_agent_in_db(test_client, tenant_id, "res-tag-admin-3", "Test App 3")
        ...
        add_user_to_chat_agent_in_db(
            test_client, tenant_id, app_id, "res-tag-reader-3", "res-tag-admin-3", PermissionActionEnum.READ
        )
    ...
    def test_write_user_can_set_resource_tags(self, test_client: TestClient) -> None:
        ...
        admin_headers = create_auth_headers(admin_token, use_cache=False)
        tenant_id = create_tenant_for_user(test_client, admin_token)
        app_id = create_chat_agent_in_db(test_client, tenant_id, "res-tag-admin-4", "Test App 4")
        ...
        add_user_to_chat_agent_in_db(
            test_client, tenant_id, app_id, "res-tag-writer-1", "res-tag-admin-4", PermissionActionEnum.WRITE
        )
    ...
    def test_write_user_can_delete_resource_tags(self, test_client: TestClient) -> None:
        ...
        admin_headers = create_auth_headers(admin_token, use_cache=False)
        tenant_id = create_tenant_for_user(test_client, admin_token)
        app_id = create_chat_agent_in_db(test_client, tenant_id, "res-tag-admin-5", "Test App 5")
        ...
        add_user_to_chat_agent_in_db(
            test_client, tenant_id, app_id, "res-tag-writer-2", "res-tag-admin-5", PermissionActionEnum.WRITE
        )

        # Writer can delete tags
        response = test_client.delete(
            ENDPOINT_CHAT_AGENT_TAGS.format(tenant_id=tenant_id, chat_agent_id=app_id), headers=writer_headers
        )
        assert response.status_code == status.HTTP_204_NO_CONTENT
    ...
    def test_admin_user_can_manage_resource_tags(self, test_client: TestClient) -> None:
        ...
        admin_headers = create_auth_headers(admin_token, use_cache=False)
        tenant_id = create_tenant_for_user(test_client, admin_token)
        app_id = create_chat_agent_in_db(test_client, tenant_id, "res-tag-admin-6", "Test App 6")
        ...
        add_user_to_chat_agent_in_db(
            test_client, tenant_id, app_id, "res-tag-admin-user-1", "res-tag-admin-6", PermissionActionEnum.ADMIN
        )
        ...
        get_response = test_client.get(
            ENDPOINT_CHAT_AGENT_TAGS.format(tenant_id=tenant_id, chat_agent_id=app_id), headers=res_admin_headers
        )
    ...
    def test_global_admin_bypasses_resource_permissions(self, test_client: TestClient) -> None:
        ...
        delete_response = test_client.delete(
            ENDPOINT_CHAT_AGENT_TAGS.format(tenant_id=tenant_id, chat_agent_id=app_id), headers=global_admin_headers
        )
        assert delete_response.status_code == status.HTTP_204_NO_CONTENT

    def test_chat_agents_admin_bypasses_resource_permissions(self, test_client: TestClient) -> None:
        """Test that tenant CHAT_AGENTS_ADMIN can manage chat agent tags."""
        # Admin creates tenant and chat agent
        admin_token = test_client.create_test_user("res-tag-admin-8", "Resource Tag Admin 8")
        admin_headers = create_auth_headers(admin_token, use_cache=False)
        tenant_id = create_tenant_for_user(test_client, admin_token)
        app_id = create_chat_agent_in_db(test_client, tenant_id, "res-tag-admin-8", "Test App 8")

        # Create CHAT_AGENTS_ADMIN
        ...
        add_user_to_tenant(test_client, tenant_id, admin_headers, "res-tag-apps-admin-1", "CHAT_AGENTS_ADMIN")

        # Chat agents admin can set tags
        set_response = test_client.put(
            ENDPOINT_CHAT_AGENT_TAGS.format(tenant_id=tenant_id, chat_agent_id=app_id),
