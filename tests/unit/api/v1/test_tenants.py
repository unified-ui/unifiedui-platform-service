...
class TestTenantRoutes:
    ...
    def test_create_tenant_success(
        ...
        response = test_client.post(ENDPOINT_TENANTS, json=sample_tenant_data, headers=auth_headers)
    ...
    def test_create_tenant_missing_name(self, test_client: TestClient, auth_headers: dict[str, str]) -> None:
        ...
        response = test_client.post(ENDPOINT_TENANTS, json={"description": tenant_description}, headers=auth_headers)
    ...
    def test_create_tenant_invalid_name_type(self, test_client: TestClient, auth_headers: dict[str, str]) -> None:
        ...
        response = test_client.post(ENDPOINT_TENANTS, json={"name": 123, "description": "Test"}, headers=auth_headers)
    ...
    def test_create_tenant_empty_name(self, test_client: TestClient, auth_headers: dict[str, str]) -> None:
        ...
        response = test_client.post(ENDPOINT_TENANTS, json={"name": "", "description": "Test"}, headers=auth_headers)

        assert response.status_code == 422

    def test_create_tenant_invalid_description_type(
        self, test_client: TestClient, auth_headers: dict[str, str]
    ) -> None:
        """Test tenant creation with invalid description type."""
        response = test_client.post(
            ENDPOINT_TENANTS, json={"name": "Test Tenant", "description": 123}, headers=auth_headers
        )
    ...
    def test_create_tenant_empty_body(self, test_client: TestClient, auth_headers: dict[str, str]) -> None:
        ...
        response = test_client.post(ENDPOINT_TENANTS, json={}, headers=auth_headers)
    ...
    def test_create_tenant_multiple_users(self, test_client: TestClient, sample_tenant_data: dict[str, Any]) -> None:
        ...
        response1 = test_client.post(
            ENDPOINT_TENANTS, json={"name": tenant1_name, "description": tenant1_desc}, headers=headers1
        )
        ...
        response2 = test_client.post(
            ENDPOINT_TENANTS, json={"name": tenant2_name, "description": tenant2_desc}, headers=headers2
        )
    ...
    def test_get_tenant_success(
        ...
        # Then retrieve it
        response = test_client.get(ENDPOINT_TENANT_DETAIL.format(tenant_id=tenant_id), headers=auth_headers)
    ...
    def test_list_tenants_empty(self, test_client: TestClient, auth_headers: dict[str, str]) -> None:
        ...
        response = test_client.get(ENDPOINT_TENANTS, headers=auth_headers)
    ...
    def test_list_tenants_with_data(
        self,
        test_client: TestClient,
        auth_headers: dict[str, str],
        sample_tenant_data: dict[str, Any],
    ...
    def test_list_tenants_with_pagination(
        ...
        # Test with limit
        response = test_client.get(f"{ENDPOINT_TENANTS}?limit=3", headers=auth_headers)
        ...
        # Test with skip
        response = test_client.get(f"{ENDPOINT_TENANTS}?skip=2&limit=2", headers=auth_headers)
    ...
    def test_list_tenants_with_name_filter(
        ...
        # Filter by name
        response = test_client.get(f"{ENDPOINT_TENANTS}?name=Development", headers=auth_headers)
    ...
    def test_list_tenants_with_order_by_name_asc(
        self, test_client: TestClient, auth_headers: dict[str, str], test_user_token: Any
    ) -> None:
        ...
        response = test_client.get(f"{ENDPOINT_TENANTS}?order_by=name&order_direction=asc", headers=auth_headers)
    ...
    def test_list_tenants_with_order_by_name_desc(
        self, test_client: TestClient, auth_headers: dict[str, str], test_user_token: Any
    ) -> None:
        ...
        response = test_client.get(f"{ENDPOINT_TENANTS}?order_by=name&order_direction=desc", headers=auth_headers)
    ...
    def test_list_tenants_order_by_without_direction(
        self, test_client: TestClient, auth_headers: dict[str, str], test_user_token: Any
    ) -> None:
        ...
        response = test_client.get(f"{ENDPOINT_TENANTS}?order_by=name", headers=auth_headers)
    ...
    def test_update_tenant_success(
        ...
        auth_headers: dict[str, str],
        sample_tenant_data: dict[str, Any],
        sample_update_tenant_data: dict[str, Any],
        test_user_token: Any,
    ) -> None:
        ...
        response = test_client.patch(
            ENDPOINT_TENANT_DETAIL.format(tenant_id=tenant_id), json=sample_update_tenant_data, headers=auth_headers
        )
    ...
    def test_update_tenant_partial(
        ...
        # Update only name
        response = test_client.patch(
            ENDPOINT_TENANT_DETAIL.format(tenant_id=tenant_id), json={"name": "Partially Updated"}, headers=auth_headers
        )
    ...
    def test_delete_tenant_success(
        ...
        response = test_client.request(
            "DELETE", ENDPOINT_TENANT_DETAIL.format(tenant_id=tenant_id), headers=auth_headers
        )
...
class TestTenantPrincipalRoutes:
    ...
    def test_list_tenant_principals_empty(
        self,
        test_client: TestClient,
        auth_headers: dict[str, str],
        sample_tenant_data: dict[str, Any],
        ...
        # List principals
        response = test_client.get(ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id), headers=auth_headers)
    ...
    def test_get_principal_permissions(
        self,
        test_client: TestClient,
        auth_headers: dict[str, str],
        sample_tenant_data: dict[str, Any],
        ...
        response = test_client.get(
            ENDPOINT_PRINCIPAL_DETAIL.format(tenant_id=tenant_id, principal_id="test-user-123"), headers=auth_headers
        )
    ...
    def test_set_principal_permission_new_user(
        ...
        role_data = {"principal_id": "user-456", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_READER}

        response = test_client.put(
            ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id), json=role_data, headers=auth_headers
        )
    ...
    def test_set_principal_permission_add_role(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
        ...
        # Add first role
        role_data_1 = {"principal_id": "user-789", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_READER}
        test_client.put(ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id), json=role_data_1, headers=auth_headers)
        ...
        response = test_client.put(
            ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id), json=role_data_2, headers=auth_headers
        )
        ...
        assert ROLE_READER in data["roles"]
        assert ROLE_CHAT_AGENTS_ADMIN in data["roles"]

    def test_set_principal_permission_duplicate_role(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
        ...
        # Add role first time
        role_data = {"principal_id": "user-999", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_READER}
        test_client.put(ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id), json=role_data, headers=auth_headers)
    ...
    def test_set_principal_permission_with_different_users(
        self, test_client: TestClient, sample_tenant_data: dict[str, Any]
    ) -> None:
        ...
        create_response = test_client.post(ENDPOINT_TENANTS, json=sample_tenant_data, headers=admin_headers)
        tenant_id = create_response.json()["id"]

        # Create additional test users
        test_client.create_test_user("user-001", "User One")
        test_client.create_test_user("user-002", "User Two")
        ...
        # Admin adds user2 with CHAT_AGENTS_ADMIN role
        response2 = test_client.put(
            ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id),
            json={"principal_id": "user-002", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_CHAT_AGENTS_ADMIN},
            headers=admin_headers,
        )
        assert response2.status_code == status.HTTP_200_OK
        assert ROLE_CHAT_AGENTS_ADMIN in response2.json()["roles"]

        # List all principals
        list_response = test_client.get(ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id), headers=admin_headers)
    ...
    def test_set_principal_permission_missing_principal_id(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
        ...
        response = test_client.put(
            ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id),
            json={"principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_READER},
            headers=auth_headers,
        )

        assert response.status_code == 422

    def test_set_principal_permission_missing_role(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
        ...
        response = test_client.put(
            ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id),
            json={"principal_id": "test-user", "principal_type": PRINCIPAL_TYPE_USER},
            headers=auth_headers,
        )

        assert response.status_code == 422

    def test_set_principal_permission_missing_principal_type(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
        ...
        response = test_client.put(
            ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id),
            json={"principal_id": "test-user", "role": ROLE_READER},
            headers=auth_headers,
        )

        assert response.status_code == 422

    def test_set_principal_permission_empty_body(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
        ...
        response = test_client.put(
            ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id), json={}, headers=auth_headers
        )

        assert response.status_code == 422

    def test_delete_principal_permission(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
        ...
        test_client.put(
            ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id),
            json={"principal_id": user_id, "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_CHAT_AGENTS_ADMIN},
            headers=auth_headers,
        )

        # Delete one role
        delete_data = {"principal_id": user_id, "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_READER}

        response = test_client.request(
            "DELETE", ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id), json=delete_data, headers=auth_headers
        )
    ...
    def test_delete_principal_permission_not_found(
        self,
        test_client: TestClient,
        auth_headers: dict[str, str],
        sample_tenant_data: dict[str, Any],
        ...
        delete_data = {"principal_id": "non-existent-user", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_READER}
    ...
    def test_delete_principal_permission_missing_principal_id(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
    ...
    def test_delete_principal_permission_missing_role(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
    ...
    def test_delete_principal_permission_missing_principal_type(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
    ...
    def test_delete_principal_permission_empty_body(
        self, test_client: TestClient, auth_headers: dict[str, str], sample_tenant_data: dict[str, Any]
    ) -> None:
        ...
        response = test_client.request(
            "DELETE", ENDPOINT_TENANT_PRINCIPALS.format(tenant_id=tenant_id), json={}, headers=auth_headers
        )
    ...
    def test_multi_user_access_control(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        tenant1_response = test_client.post(
            ENDPOINT_TENANTS, json={"name": "User 1 Tenant", "description": "Private to user 1"}, headers=headers1
        )
        ...
        tenant2_response = test_client.post(
            ENDPOINT_TENANTS, json={"name": "User 2 Tenant", "description": "Private to user 2"}, headers=headers2
        )
