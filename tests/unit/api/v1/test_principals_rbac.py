...
class TestPrincipalRBAC:
    ...
    def test_global_admin_can_update_status(
        ...
        response = test_client.patch(
            ENDPOINT_PRINCIPAL_STATUS.format(tenant_id=tenant_id, principal_id=test_user_token.get_id()),
    ...
    def test_reader_cannot_update_status(
        ...
        reader_token = create_test_user(user_id="reader-user", name="Reader User")
        ...
        test_client.put(
            ...
            json={"principal_id": reader_token.get_id(), "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_READER},
            headers=auth_headers,
        )
    ...
    def test_reader_can_get_principal(
        ...
        reader_token = create_test_user(user_id="reader-user-2", name="Reader User 2")
        reader_headers = create_auth_headers(reader_token, use_cache=False)
        ...
        response = test_client.get(
            ENDPOINT_PRINCIPAL_DETAIL.format(tenant_id=tenant_id, principal_id=test_user_token.get_id()),
            headers=reader_headers,
        )
    ...
    def test_global_admin_can_refresh_principal(
        ...
        response = test_client.patch(
            ENDPOINT_PRINCIPAL_REFRESH.format(tenant_id=tenant_id, principal_id=test_user_token.get_id()),
    ...
    def test_reader_cannot_refresh_principal(
        ...
        # Create second user with only READER role
        reader_token = create_test_user(user_id="reader-user-3", name="Reader User 3")
        reader_headers = create_auth_headers(reader_token, use_cache=False)
    ...
    def test_non_member_cannot_access_principals(
        ...
        outsider_token = create_test_user(user_id="outsider-user", name="Outsider User")
