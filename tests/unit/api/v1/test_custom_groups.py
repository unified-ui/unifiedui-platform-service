...
class TestCustomGroupRoutes:
    ...
    def test_create_custom_group_success(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        # Create custom group
        group_data = {"name": "Test Group", "description": "A test custom group"}

        response = test_client.post(
            ENDPOINT_CUSTOM_GROUPS.format(tenant_id=tenant_id), json=group_data, headers=headers
        )
    ...
    def test_create_custom_group_missing_name(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.post(
            ENDPOINT_CUSTOM_GROUPS.format(tenant_id=tenant_id), json={"description": "Test group"}, headers=headers
        )
    ...
    def test_create_custom_group_empty_body(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.post(ENDPOINT_CUSTOM_GROUPS.format(tenant_id=tenant_id), json={}, headers=headers)
    ...
    def test_get_custom_group_not_found(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(
            ENDPOINT_CUSTOM_GROUP_DETAIL.format(tenant_id=tenant_id, custom_group_id=NON_EXISTENT_ID), headers=headers
        )
    ...
    def test_list_custom_groups_empty(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(ENDPOINT_CUSTOM_GROUPS.format(tenant_id=tenant_id), headers=headers)
    ...
    def test_list_custom_groups_with_data(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        test_client.post(ENDPOINT_CUSTOM_GROUPS.format(tenant_id=tenant_id), json=group1_data, headers=headers)
        test_client.post(ENDPOINT_CUSTOM_GROUPS.format(tenant_id=tenant_id), json=group2_data, headers=headers)
    ...
    def test_list_custom_groups_with_pagination(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        # Test with limit
        response = test_client.get(f"{ENDPOINT_CUSTOM_GROUPS.format(tenant_id=tenant_id)}?limit=3", headers=headers)
        ...
        # Test with skip
        response = test_client.get(
            f"{ENDPOINT_CUSTOM_GROUPS.format(tenant_id=tenant_id)}?skip=2&limit=2", headers=headers
        )
    ...
    def test_list_custom_groups_with_name_filter(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        # Filter by name
        response = test_client.get(
            f"{ENDPOINT_CUSTOM_GROUPS.format(tenant_id=tenant_id)}?name=Development", headers=headers
        )
    ...
    def test_update_custom_group_partial(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        create_response = test_client.post(
            ENDPOINT_CUSTOM_GROUPS.format(tenant_id=tenant_id), json=original_data, headers=headers
        )
        group_id = create_response.json()["id"]
...
class TestCustomGroupPrincipalRoutes:
    ...
    def test_list_custom_group_principals_creator_only(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        # List principals
        response = test_client.get(
            ENDPOINT_CUSTOM_GROUP_PRINCIPALS.format(tenant_id=tenant_id, custom_group_id=group_id), headers=headers
        )
    ...
    def test_get_principal_permissions(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(
            ENDPOINT_PRINCIPAL_DETAIL.format(
                tenant_id=tenant_id, custom_group_id=group_id, principal_id=test_user_token.get_id()
            ),
            headers=headers,
        )
    ...
    def test_set_principal_permission_new_user(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        permission_data = {"principal_id": "user-456", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_READ}
    ...
    def test_set_principal_permission_update_existing(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        test_client.put(
            ENDPOINT_CUSTOM_GROUP_PRINCIPALS.format(tenant_id=tenant_id, custom_group_id=group_id),
            json={"principal_id": "user-789", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_READ},
            headers=headers,
        )
        ...
        response = test_client.put(
            ENDPOINT_CUSTOM_GROUP_PRINCIPALS.format(tenant_id=tenant_id, custom_group_id=group_id),
            json={"principal_id": "user-789", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_WRITE},
            headers=headers,
        )
    ...
    def test_delete_principal_permission(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        test_client.put(
            ENDPOINT_CUSTOM_GROUP_PRINCIPALS.format(tenant_id=tenant_id, custom_group_id=group_id),
            json={"principal_id": "user-delete", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_READ},
            headers=headers,
        )
