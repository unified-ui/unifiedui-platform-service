...
PRINCIPAL_TYPE_CUSTOM_GROUP = "CUSTOM_GROUP"
...
class TestCustomGroupRBAC:
    ...
    def test_user_role_replacement(self, test_client: TestClient) -> None:
        ...
        # Create test user
        test_user_token = test_client.create_test_user("test-user", "Test User")
    ...
    def test_tenant_custom_groups_admin_bypasses_custom_group_permissions(self, test_client: TestClient) -> None:
        ...
        test_client.put(
            f"/api/v1/tenants/{tenant_id}/principals",
            json={
                "principal_id": "groups-admin",
                "principal_type": PRINCIPAL_TYPE_USER,
                "role": "CUSTOM_GROUPS_ADMIN"
            },
            headers=headers_a
        )
