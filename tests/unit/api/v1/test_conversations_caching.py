...
class TestConversationCaching:
    ...
    def test_conversations_list_cached_after_permission_grant(
        ...
        conversation_data = {"chat_agent_id": chat_agent_id, "name": "Test Conversation", "description": "Test"}
        create_response = test_client.post(
            ENDPOINT_CONVERSATIONS.format(tenant_id=tenant_id), json=conversation_data, headers=headers1
        )
        ...
        list1 = test_client.get(ENDPOINT_CONVERSATIONS.format(tenant_id=tenant_id), headers=headers2)
        assert len(list1.json()) == 1

        # User2 lists again (should use cache)
        list2 = test_client.get(ENDPOINT_CONVERSATIONS.format(tenant_id=tenant_id), headers=headers2)
        assert len(list2.json()) == 1

    def test_conversations_list_cached_after_permission_revoke(
        self, test_client: TestClient, fake_redis_client: Any
    ) -> None:
    ...
    def test_conversations_list_cached_after_multiple_permission_changes(
        self, test_client: TestClient, fake_redis_client: Any
    ) -> None:
        ...
        conv1_response = test_client.post(
            ...
            json={"chat_agent_id": chat_agent_id, "name": "Conversation 1", "description": "Test"},
            headers=headers1,
        )
        ...
        conv2_response = test_client.post(
            ENDPOINT_CONVERSATIONS.format(tenant_id=tenant_id),
            json={"chat_agent_id": chat_agent_id, "name": "Conversation 2", "description": "Test"},
            headers=headers1,
        )
        ...
        list3 = test_client.get(ENDPOINT_CONVERSATIONS.format(tenant_id=tenant_id), headers=headers2)
        ...
        list4 = test_client.get(ENDPOINT_CONVERSATIONS.format(tenant_id=tenant_id), headers=headers2)
    ...
    def test_conversation_detail_cached_correctly(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        get1 = test_client.get(
            ENDPOINT_CONVERSATION_DETAIL.format(tenant_id=tenant_id, conversation_id=conversation_id), headers=headers1
        )
    ...
    def test_cache_isolation_between_users(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        list1 = test_client.get(ENDPOINT_CONVERSATIONS.format(tenant_id=tenant_id), headers=headers1)
        assert len(list1.json()) == 1
    ...
    def test_conversation_principals_list_cached_correctly(
        self, test_client: TestClient, fake_redis_client: Any
    ) -> None:
