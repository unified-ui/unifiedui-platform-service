...
class TestTagsPagination:
    ...
    def test_list_tags_default_pagination(self, test_client: TestClient, test_user_token: Any) -> None:
    ...
    def test_list_tags_with_limit(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        # Test with limit=5
        response = test_client.get(ENDPOINT_TAGS.format(tenant_id=tenant_id), params={"limit": 5}, headers=headers)
    ...
    def test_list_tags_with_skip(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        # Test with skip=2
        response = test_client.get(ENDPOINT_TAGS.format(tenant_id=tenant_id), params={"skip": 2}, headers=headers)
    ...
    def test_list_tags_with_skip_and_limit(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(
            ENDPOINT_TAGS.format(tenant_id=tenant_id), params={"skip": 3, "limit": 4}, headers=headers
        )
    ...
    def test_list_tags_with_name_filter(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(ENDPOINT_TAGS.format(tenant_id=tenant_id), params={"name": "BACK"}, headers=headers)
    ...
    def test_list_tags_name_filter_with_pagination(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(
            ENDPOINT_TAGS.format(tenant_id=tenant_id), params={"name": "TAG", "limit": 3}, headers=headers
        )
    ...
    def test_list_tags_invalid_limit(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(ENDPOINT_TAGS.format(tenant_id=tenant_id), params={"limit": 0}, headers=headers)

        # Verify
        assert response.status_code == status.HTTP_422_UNPROCESSABLE_CONTENT

    def test_list_tags_negative_skip(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(ENDPOINT_TAGS.format(tenant_id=tenant_id), params={"skip": -1}, headers=headers)

        # Verify
        assert response.status_code == status.HTTP_422_UNPROCESSABLE_CONTENT

    def test_list_tags_skip_beyond_total(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(ENDPOINT_TAGS.format(tenant_id=tenant_id), params={"skip": 10}, headers=headers)
...
class TestResourceTypeTagsList:
    ...
    def test_list_chat_agent_tags(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test listing tags that are applied to chat agents."""
        # Setup
        headers = create_auth_headers(test_user_token, use_cache=False)
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        test_user_token.get_id()

        # Create chat agent via API
        ...
        # Create tags and assign to chat agent
        create_tag(test_client, tenant_id, headers, "BACKEND")
        create_tag(test_client, tenant_id, headers, "PRODUCTION")
        ...
        # Test
        response = test_client.get(
            ENDPOINT_RESOURCE_TYPE_TAGS.format(tenant_id=tenant_id, resource_type="chat-agents"), headers=headers
        )
    ...
    def test_list_resource_tags_with_name_filter(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test filtering resource tags by name."""
        # Setup
        headers = create_auth_headers(test_user_token, use_cache=False)
        tenant_id = create_tenant_for_user(test_client, test_user_token)

        # Create chat agent and tags
        app_response = test_client.post(
            f"/api/v1/platform-service/tenants/{tenant_id}/chat-agents",
            json={"name": "Test App", "description": "Test", "type": "N8N", "config": {}},
            headers=headers,
        ...
        # Test with filter
        response = test_client.get(
            ENDPOINT_RESOURCE_TYPE_TAGS.format(tenant_id=tenant_id, resource_type="chat-agents"),
            params={"name": "BACK"},
            headers=headers,
        )
    ...
    def test_list_resource_tags_with_pagination(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test paginating resource tags."""
        # Setup
        headers = create_auth_headers(test_user_token, use_cache=False)
        tenant_id = create_tenant_for_user(test_client, test_user_token)

        # Create chat agent with many tags
        app_response = test_client.post(
            f"/api/v1/platform-service/tenants/{tenant_id}/chat-agents",
            json={"name": "Test App", "description": "Test", "type": "N8N", "config": {}},
            headers=headers,
    ...
    def test_list_resource_tags_invalid_resource_type(self, test_client: TestClient, test_user_token: Any) -> None:
        ...
        response = test_client.get(
            ENDPOINT_RESOURCE_TYPE_TAGS.format(tenant_id=tenant_id, resource_type="invalid-type"), headers=headers
        )

        # Verify - 404 because no route matches /invalid-type/tags
        assert response.status_code == status.HTTP_404_NOT_FOUND

    def test_list_resource_tags_empty(self, test_client: TestClient, test_user_token: Any) -> None:
