...
def create_chat_widget(test_client: TestClient, tenant_id: str, headers: dict, name: str = "Test Widget") -> str:
    ...
    response = test_client.post(
        ...
        json={"name": name, "description": f"Chat Widget {name}", "type": "IFRAME", "config": {"key": "value"}},
        headers=headers,
    )
    assert response.status_code == status.HTTP_201_CREATED
    return response.json()["id"]
...
class TestChatWidgetCaching:
    ...
    def test_creator_permissions_cached(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        response1 = test_client.get(
            ENDPOINT_CHAT_WIDGET_DETAIL.format(tenant_id=tenant_id, chat_widget_id=widget_id), headers=headers
        )
    ...
    def test_no_access_cached(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        response1 = test_client.get(
            ENDPOINT_CHAT_WIDGET_DETAIL.format(tenant_id=tenant_id, chat_widget_id=widget_id), headers=headers_b
        )
    ...
    def test_permission_grant_invalidates_cache(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        response_before = test_client.get(
            ENDPOINT_CHAT_WIDGET_DETAIL.format(tenant_id=tenant_id, chat_widget_id=widget_id), headers=user_headers
        )
        ...
        test_client.put(
            ...
            json={"principal_id": "cw-cache-user-1", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_WRITE},
            headers=admin_headers,
        )
    ...
    def test_permission_revoke_invalidates_cache(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        test_client.put(
            ENDPOINT_CHAT_WIDGET_PRINCIPALS.format(tenant_id=tenant_id, chat_widget_id=widget_id),
            json={"principal_id": "cw-cache-user-2", "principal_type": PRINCIPAL_TYPE_USER, "role": ROLE_ADMIN},
            headers=admin_headers,
        )
    ...
    def test_chat_widgets_list_cached_correctly(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        response1 = test_client.get(ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), headers=user_headers)
        assert response1.status_code == status.HTTP_200_OK
        ...
        response2 = test_client.get(ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), headers=user_headers)
        assert response2.status_code == status.HTTP_200_OK
        data = response2.json()
        assert len(data) == 2
    ...
    def test_cache_isolated_between_users(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        get_a = test_client.get(
            ENDPOINT_CHAT_WIDGET_DETAIL.format(tenant_id=tenant_id, chat_widget_id=widget_id), headers=user_a_headers
        )
...
class TestChatWidgetTagCacheInvalidation:
    ...
    def test_adding_tags_invalidates_cache(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        response1 = test_client.get(
            ENDPOINT_CHAT_WIDGET_DETAIL.format(tenant_id=tenant_id, chat_widget_id=widget_id), headers=admin_headers
        )
    ...
    def test_removing_tags_invalidates_cache(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        # Remove tags
        test_client.delete(
            ENDPOINT_CHAT_WIDGET_TAGS.format(tenant_id=tenant_id, chat_widget_id=widget_id), headers=admin_headers
        )
...
class TestChatWidgetListCaching:
    ...
    def test_list_cached_with_is_active(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        response_active = test_client.get(
            ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), params={"is_active": 1}, headers=headers
        )
        ...
        response_inactive = test_client.get(
            ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), params={"is_active": 0}, headers=headers
        )
        ...
        response_all = test_client.get(ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), headers=headers)
    ...
    def test_list_cache_key_includes_all_params(self, test_client: TestClient, fake_redis_client: Any) -> None:
        ...
        for params in combos:
            response = test_client.get(
                ENDPOINT_CHAT_WIDGETS.format(tenant_id=tenant_id), params=params, headers=headers
            )
            assert response.status_code == status.HTTP_200_OK
