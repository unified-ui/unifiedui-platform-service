...
class TestReActAgentRouteExceptionHandling:
    """Test generic exception handling in ReACT agent routes."""

    def test_list_re_act_agents_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test list ReACT agents returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)

        mock_handler = make_failing_handler()
        test_client.app.dependency_overrides[get_re_act_agent_handler] = lambda: mock_handler

        response = test_client.get(f"/api/v1/platform-service/tenants/{tenant_id}/re-act-agents", headers=headers)
        assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR

        del test_client.app.dependency_overrides[get_re_act_agent_handler]

    def test_create_re_act_agent_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test create ReACT agent returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
        ...
        response = test_client.post(
            f"/api/v1/platform-service/tenants/{tenant_id}/re-act-agents",
            json={"name": "Agent", "description": "desc"},
            headers=headers,
        )
        assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR
    ...
    def test_get_re_act_agent_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test get ReACT agent returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
        ...
        response = test_client.get(
            f"/api/v1/platform-service/tenants/{tenant_id}/re-act-agents/{FAKE_ID}", headers=headers
        )
        assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR

        del test_client.app.dependency_overrides[get_re_act_agent_handler]

    def test_update_re_act_agent_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test update ReACT agent returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
        ...
        response = test_client.patch(
            f"/api/v1/platform-service/tenants/{tenant_id}/re-act-agents/{FAKE_ID}",
            json={"name": "Updated"},
            headers=headers,
        )
        assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR
    ...
    def test_delete_re_act_agent_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test delete ReACT agent returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
    ...
    def test_list_re_act_agent_principals_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test list ReACT agent principals returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
        ...
        response = test_client.get(
            f"/api/v1/platform-service/tenants/{tenant_id}/re-act-agents/{FAKE_ID}/principals",
            headers=headers,
        )
        assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR
    ...
    def test_set_re_act_agent_permission_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test set ReACT agent permission returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
    ...
    def test_delete_re_act_agent_principal_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test delete ReACT agent principal returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
        ...
        response = test_client.delete(
            f"/api/v1/platform-service/tenants/{tenant_id}/re-act-agents/{FAKE_ID}/principals/{FAKE_ID}"
            "?principal_type=IDENTITY_USER&permission=READ",
            headers=headers,
        )
        assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR
    ...
    def test_list_re_act_agents_invalid_tags_format(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test list ReACT agents with invalid tag IDs returns 400."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)

        response = test_client.get(
            f"/api/v1/platform-service/tenants/{tenant_id}/re-act-agents?tags=abc", headers=headers
        )
        assert response.status_code == status.HTTP_400_BAD_REQUEST
...
class TestTagRouteExceptionHandling:
    ...
    def test_get_re_act_agent_tags_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test get ReACT agent tags returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
        ...
        response = test_client.get(
            f"/api/v1/platform-service/tenants/{tenant_id}/re-act-agents/{FAKE_ID}/tags",
            headers=headers,
        )
        assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR
    ...
    def test_set_re_act_agent_tags_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test set ReACT agent tags returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
    ...
    def test_delete_re_act_agent_tags_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test delete ReACT agent tags returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
    ...
    def test_list_re_act_agent_type_tags_500(self, test_client: TestClient, test_user_token: Any) -> None:
        """Test list ReACT agent type tags returns 500 on unexpected error."""
        tenant_id = create_tenant_for_user(test_client, test_user_token)
        headers = create_auth_headers(test_user_token, use_cache=False)
        ...
        response = test_client.get(
            f"/api/v1/platform-service/tenants/{tenant_id}/re-act-agents/tags",
            headers=headers,
        )
        assert response.status_code == status.HTTP_500_INTERNAL_SERVER_ERROR
