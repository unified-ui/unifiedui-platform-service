...
class TestBaseVault:
    ...
    def test_has_store_secret_method(self):
        ...
        assert callable(BaseVault.store_secret)
    ...
    def test_has_get_secret_method(self):
        ...
        assert callable(BaseVault.get_secret)
    ...
    def test_has_update_secret_method(self):
        ...
        assert callable(BaseVault.update_secret)
