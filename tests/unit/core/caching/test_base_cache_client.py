...
class MockBaseCache(BaseCache):
    ...
    def delete_pattern(self, pattern: str) -> int:
        ...
        to_delete = [k for k in self.storage.keys() if re.match(regex, k)]
        for k in to_delete:
            del self.storage[k]
