...
class TestMockIdentityToken:
    ...
    def test_initialization_with_all_params(self):
        ...
        token = MockIdentityToken(
            user_id="user-123", name="John Doe", mail="john@example.com", idp_groups=["group-1", "group-2"]
        )
        assert token.get_id() == "user-123"
    ...
    def test_to_dict_method(self):
        ...
        token = MockIdentityToken(user_id="user-123", name="Alice Smith", mail="alice@example.com")
