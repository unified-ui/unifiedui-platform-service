...
class TestExtraIDIdentityProvider:
    ...
    def setup_method(self):
        """Setup test fixtures."""
        self.token_data = {"oid": "user-123", "tid": "tenant-456", "name": "Test User"}
    ...
    def test_get_current_user_security_groups(self, mock_get):
        ...
        mock_response.json.return_value = {
            "value": [{"id": "group-1", "displayName": "Group 1"}, {"id": "group-2", "displayName": "Group 2"}]
        }
    ...
    def test_get_users(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {
            "value": [{"id": "u1", "displayName": "User 1", "userPrincipalName": "user1@test.com"}],
    ...
    def test_get_users_with_search(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {
            "value": [{"id": "u1", "displayName": "John", "userPrincipalName": "john@test.com"}]
        }
        mock_get.return_value = mock_response
    ...
    def test_get_users_with_next_link(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {
            "value": [{"id": "u1", "displayName": "User", "userPrincipalName": "user@test.com"}]
        }
        mock_get.return_value = mock_response
    ...
    def test_get_group_by_id(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {"id": "group-xyz", "displayName": "Admin Group"}
        mock_get.return_value = mock_response
    ...
    def test_parse_groups_response(self):
        ...
        data = {"value": [{"id": "g1", "displayName": "Group 1"}, {"id": "g2", "displayName": "Group 2"}]}
    ...
    def test_parse_users_response(self):
        ...
        data = {"value": [{"id": "u1", "displayName": "User 1", "userPrincipalName": "u1@test.com"}]}
