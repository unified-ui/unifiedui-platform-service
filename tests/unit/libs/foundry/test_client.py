...
class TestMicrosoftFoundryClient:
    ...
    def test_create_conversation_with_metadata(self, mock_post):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {"id": "conv_12345", "metadata": {"custom": "data"}}
        mock_response.raise_for_status = Mock()
        mock_post.return_value = mock_response
    ...
    def test_get_conversation_id_success(self, mock_post):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {"id": "conv_12345", "object": "conversation"}
        mock_response.raise_for_status = Mock()
        mock_post.return_value = mock_response
...
class TestMicrosoftFoundryError:
    ...
    def test_error_with_all_fields(self):
        ...
        error = MicrosoftFoundryError(
            message="Test error", status_code=500, response_body='{"error": "Internal error"}'
        )
