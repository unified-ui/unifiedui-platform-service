...
async def list_user_favorites(
    ...
    Args:
        ...
        resource_type: Type of resource (applications, autonomous-agents, development-platforms, conversations)
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail="Failed to list user favorites"
        )
...
async def add_user_favorite(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to add user favorite"
        )
...
async def remove_user_favorite(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to remove user favorite"
        )
