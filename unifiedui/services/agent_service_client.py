...
class AgentServiceClient:
    ...
    def __init__(
        self,
        base_url: str,
        app_vault: Optional[BaseVaultClient] = None,
        timeout: int = 30
    ):
        """
    ...
    def delete_conversation_data(self, tenant_id: str, conversation_id: str) -> bool:
        ...
        """
        url = (
            f"{self._base_url}/api/v1/agent-service/tenants/{tenant_id}"
            f"/conversations/{conversation_id}/data"
        )
    ...
    def delete_autonomous_agent_data(self, tenant_id: str, autonomous_agent_id: str) -> bool:
        ...
        url = (
            f"{self._base_url}/api/v1/agent-service/tenants/{tenant_id}"
            f"/autonomous-agents/{autonomous_agent_id}/data"
        )
