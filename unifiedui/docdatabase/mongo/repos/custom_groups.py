...
class MongoDBCustomGroupsCollection(CustomGroupsCollection):
    ...
    def get(self, group_id: str) -> CustomGroupModel | None:
    ...
    def get_list(self, filters: dict | None = None, skip: int = 0, limit: int = 100) -> list[CustomGroupModel]:
    ...
    def create(
        self, tenant_id: str, name: str, description: str | None, member_ids: list[str], created_by: str
    ) -> CustomGroupModel:
    ...
    def update(
        self, group_id: str, name: str | None, description: str | None, updated_by: str
    ) -> CustomGroupModel | None:
        """Update an existing custom group."""
        update_fields = {"updated_at": datetime.now(UTC), "updated_by": updated_by}
        ...
        result = self._collection.find_one_and_update({"id": group_id}, {"$set": update_fields}, return_document=True)
    ...
    def add_members(self, group_id: str, user_ids: list[str], updated_by: str) -> CustomGroupModel | None:
        ...
        result = self._collection.find_one_and_update(
            {"id": group_id},
            {
                ...
                "$set": {"updated_at": datetime.now(UTC), "updated_by": updated_by},
            },
    ...
    def remove_members(self, group_id: str, user_ids: list[str], updated_by: str) -> CustomGroupModel | None:
        ...
        result = self._collection.find_one_and_update(
            {"id": group_id},
            {"$pullAll": {"member_ids": user_ids}, "$set": {"updated_at": datetime.now(UTC), "updated_by": updated_by}},
            return_document=True,
        )
