...
class CreateCustomGroupRequest(BaseModel):
    ...
    description: str | None = Field(default=None, max_length=1000, description="Group description")


class UpdateCustomGroupRequest(BaseModel):
    """Request model for updating a custom group."""

    name: str | None = Field(default=None, min_length=1, max_length=255, description="Group name")
