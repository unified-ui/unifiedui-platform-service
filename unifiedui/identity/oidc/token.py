"""Generic OIDC identity token serializer for JWT claims extraction."""
...
class OIDCIdentityTokenSerializer(BaseIdentityToken):
    """Extracts user identity from generic OIDC-issued JWT tokens.

    Follows standard OIDC claims: sub, email, name, given_name,
    family_name, preferred_username. Works with any OIDC-compliant issuer.
    """
    ...
    def __init__(self, token: str, deserialized_token: dict):
        ...
        """
        self._identity_provider = IdenityProviderEnum.OIDC.value
