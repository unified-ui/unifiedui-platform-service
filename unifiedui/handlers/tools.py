...
class ToolHandler:
    ...
    def list_tools(
        ...
        use_cache: bool = True
    ) -> Union[List[ToolResponse], List[QuickListItemResponse]]:
        """
        ...
        with self.db_client.get_session() as session:
            ...
            if not is_admin:
                ...
                member_subquery = (
                    ...
                    .where(
                        ToolMember.tenant_id == tenant_id,
                        ToolMember.principal_id.in_(principal_ids)
                    )
                    .distinct()
                )
            ...
            if tag_ids:
                tag_subquery = (
                    ...
                    .where(
                        ToolTag.tenant_id == tenant_id,
                        ToolTag.tag_id.in_(tag_ids)
                    )
                    .distinct()
                )
    ...
    def get_tool_permission(
        ...
        """
        logger.info(
            "Getting tool permission",
            extra={"tenant_id": tenant_id, "tool_id": tool_id, "principal_id": principal_id}
        )
