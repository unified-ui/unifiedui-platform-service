"""Workflow handler dependency for FastAPI."""
...
def get_workflow_handler(
    ...
    """
    Get a WorkflowHandler instance as a dependency.
    ...
    """
    return WorkflowHandler(db_client, cache_client, vault_client, agent_service_client=agent_service_client)
