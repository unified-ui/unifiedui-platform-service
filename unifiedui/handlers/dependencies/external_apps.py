"""External app handler dependency for FastAPI."""
...
def get_external_app_handler(
    ...
    Returns:
        ExternalAppHandler instance
    """
    return ExternalAppHandler(db_client, cache_client)
