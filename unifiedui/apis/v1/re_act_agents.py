...
@router.get(
    "",
    summary="List ReACT agents",
    description="Get a paginated list of ReACT agents for the current tenant."
)
@authenticate()
async def list_re_act_agents(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail="Failed to list ReACT agents"
        )
...
async def create_re_act_agent(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Failed to create ReACT agent: {str(e)}"
        )
...
async def get_re_act_agent(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get ReACT agent"
        )
...
async def update_re_act_agent(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Failed to update ReACT agent: {str(e)}"
        )
...
async def delete_re_act_agent(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to delete ReACT agent"
        )
...
async def list_re_act_agent_permissions(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to list ReACT agent permissions"
        )
...
async def get_re_act_agent_permission(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get ReACT agent permission"
        )
...
async def set_re_act_agent_permission(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to set ReACT agent permission"
        )
...
async def delete_re_act_agent_permission(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to delete ReACT agent permission"
        )
