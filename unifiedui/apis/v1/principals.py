...
from unifiedui.schema.requests.tenants import DeletePrincipalRequest, SetPrincipalRequest
from unifiedui.schema.responses.principals import PrincipalResponse
from unifiedui.schema.responses.tenants import PrincipalsResponse, TenantPrincipalsResponse
...
async def get_principal_permissions(
    request: Request, tenant_id: str, principal_id: str, handler: PrincipalHandler = Depends(get_principal_handler)
) -> PrincipalsResponse:
    """
