...
async def list_re_act_agent_tags(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to list ReACT agent tags"
        )
...
@re_act_agent_tags_router.get(
    "",
    response_model=List[TagResponse],
    summary="Get ReACT agent tags",
    description="Get tags for a ReACT agent"
)
@authenticate()
@check_permissions(
    entity="re_act_agent",
...
async def get_re_act_agent_tags(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get ReACT agent tags"
        )
...
async def set_re_act_agent_tags(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to set ReACT agent tags"
        )
...
async def delete_re_act_agent_tags(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to delete ReACT agent tags"
        )
